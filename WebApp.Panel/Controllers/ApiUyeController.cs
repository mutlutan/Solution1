...
namespace WebApp.Panel.Controllers
{
    ...
    [ApiController]
    public class ApiUyeController : BaseController
    {
        public ApiUyeController(IServiceProvider _serviceProvider) : base(_serviceProvider) { }

        [HttpPost("Read")]
        [ResponseCache(Duration = 0)]
        [AuthenticateRequired(AuthorityKeys = "Uye.D_R.")]
        public ActionResult Read([FromBody]ApiRequest request)
        {
            DataSourceResult dsr = new();
            try
            {
                var query = this.business.repository.RepUye.Get();
                ...
                //dsr.Data = this.business.GetAuthorityColumnsAndData(this.userToken, "Uye", dsr.Data.ToDynamicList());
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("GetByNew")]
        [ResponseCache(Duration = 0)]
        [AuthenticateRequired(AuthorityKeys = "Uye.D_C.")]
        public ActionResult GetByNew()
        {
             return Json(this.business.repository.RepUye.GetByNew());
        }
        ...
        public ActionResult Create([FromBody] object obj)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    dsr.Data = this.business.repository.RepUye.GetById(id);
                }
                else
                {
        ...
        [HttpPost("Update")]
        [ResponseCache(Duration = 0)]
        [AuthenticateRequired(AuthorityKeys = "Uye.D_U.")]
        ...
        [HttpPost("Delete")]
        [ResponseCache(Duration = 0)]
        [AuthenticateRequired(AuthorityKeys = "Uye.D_D.")]
        public ActionResult Delete([FromBody] object obj)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    this.business.repository.RepUye.Delete(model.Id);
                    this.business.repository.SaveChanges();
                }
                else
                {
