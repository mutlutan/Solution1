    ...
    id: "Menu.", text: mnLang.f("xLng.Authority.Menu"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-th fa-fw", expanded: true, prefix: false, menu: true, yetkiGrups: "11,21", items: [
        ...
        },
        {
            id: "Menu.Tanimlamalar.", text: mnLang.f("xLng.Authority.Menu.Tanimlamalar"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-newspaper-o fa-fw", expanded: false, prefix: false, menu: true, yetkiGrups: "11,21", items: [
                {
                    id: "Menu.Tanimlamalar.Currency.", text: mnLang.f("xLng.Currency.Title"), hint: "", rout: "Currency", params: "Id=1", showType: "Page", header: true, viewFolder: "Currency", viewName: "CurrencyForGrid", cssClass: "fa fa-tint fa-fw", expanded: false, prefix: true, menu: true, yetkiGrups: "11,21", items: [
                        { id: "Menu.Tanimlamalar.Currency.D_R.", text: mnLang.f("xLng.Authority.Gorebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-search fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
                        { id: "Menu.Tanimlamalar.Currency.D_C.", text: mnLang.f("xLng.Authority.Ekleyebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-plus fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
                        { id: "Menu.Tanimlamalar.Currency.D_U.", text: mnLang.f("xLng.Authority.Duzeltebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-pencil fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
                        { id: "Menu.Tanimlamalar.Currency.D_D.", text: mnLang.f("xLng.Authority.Silebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-trash-o fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
                        { id: "Menu.Tanimlamalar.Currency.D_E.", text: mnLang.f("xLng.Authority.SaveAsExcel"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-file-excel-o fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] }
                    ]
                },
                {
                    id: "Menu.Tanimlamalar.Country.", text: mnLang.f("xLng.Country.Title"), hint: "", rout: "Country", params: "Id=1", showType: "Page", header: true, viewFolder: "Country", viewName: "CountryForGrid", cssClass: "fa fa-tint fa-fw", expanded: false, prefix: true, menu: true, yetkiGrups: "11,21", items: [
                        { id: "Menu.Tanimlamalar.Country.D_R.", text: mnLang.f("xLng.Authority.Gorebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-search fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
                        { id: "Menu.Tanimlamalar.Country.D_C.", text: mnLang.f("xLng.Authority.Ekleyebilir"), hint: "", rout: "", params: "", showType: "Page", header: false, viewFolder: "", viewName: "", cssClass: "fa fa-plus fa-fw", expanded: false, prefix: false, menu: false, yetkiGrups: "11,21", items: [] },
