...
namespace AppCommon
{
	...
	public static class Extensions
	{
		...
		#region telerik ex
		public static Telerik.DataSource.FilterOperator MyToKendoFilterOperator(this string _filterOperator)
		{
			var rV = _filterOperator.ToLower() switch
			{
				...
				_ => (Telerik.DataSource.FilterOperator)Enum.Parse(typeof(Telerik.DataSource.FilterOperator), _filterOperator, true),
			};
		...
		public static Telerik.DataSource.DataSourceRequest MyToDataSourceRequest(this ApiRequest _request)
		{
			...
			if (_request.Filter != null)
			{
				...
				foreach (var filter in _request.Filter.Filters)
				{
					var filterOperator = filter.Operator.MyToKendoFilterOperator();
			...
			if (_request.Sort != null)
			{
				...
				if (_request.Sort != null)
				{
					foreach (var sort in _request.Sort)
					{
